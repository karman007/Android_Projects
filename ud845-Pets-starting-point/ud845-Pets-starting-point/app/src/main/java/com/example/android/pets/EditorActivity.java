...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data.moveToFirst()) {
            int nameColIdx = data.getColumnIndex(PetEntry.COLUMN_PET_NAME);
            int breedColIdx = data.getColumnIndex(PetEntry.COLUMN_PET_BREED);
            int genderColIdx = data.getColumnIndex(PetEntry.COLUMN_PET_GENDER);
            int weightColIdx = data.getColumnIndex(PetEntry.COLUMN_PET_WEIGHT);

            String name = data.getString(nameColIdx);
            String breed = data.getString(nameColIdx);
            int gender = data.getInt(genderColIdx);
            int weight = data.getInt(weightColIdx);
